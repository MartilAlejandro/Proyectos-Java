...
/**
 * 2. Uso de la librería Math Desarrolle un programa que pida al usuario el
 * radio de un círculo. Utilizando la constante Math.PI y la función Math.pow()
 * de la librería matemática de Java, calcule el área y circunferencia de dicho
 * círculo y muestre el resultado al usuario.
 *
 * @author marti
 */
